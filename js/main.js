(function ($) {
 ...
 $('.main_menu .submenu-blocks a').hover(function (e) {
            var imghover = $(this).data('imagehover');
            var fadeTime = 100;
            if (imghover) {
                $(this)
                    .closest('.submenu-blocks')
                    .find('.views-field-field-sub-image img')
                    .stop()
                    .fadeOut(fadeTime, function (e) {
                        if (!$(this).data('defaultsrc')) {
                ...
                var img = $(this)
                    .closest('.submenu-blocks')
                    .find('.views-field-field-sub-image img');
                var defaultsrc = $(img).data('defaultsrc');
		...
		$('.product__favorite').addClass("animated");
		setTimeout(RemoveClass, 5000);
		});
		function RemoveClass() {
		$('.product__favorite').removeClass("animated");
		}
		}); 
