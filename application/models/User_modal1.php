...
class User_modal extends CI_Model 
{
 ...
 if($usertype == 'customer')
  	$user = 'user';  
		// $select = "SELECT * FROM user LEFT JOIN store ON user.user_agent_id = store.store_id LEFT JOIN address ON user.user_id = address.address_user_id WHERE user_type = '$user'";
