...
class TootController_Ar extends CI_Controller {
...
// homepage
  public function index()
  {
    ...
    $this->load->view('ar/toottemplatear',$result);
  }
...
public function tabsortproducts()
{
  $a['tabproducts'] = $this->TootModel->get_categories();
    ...
    $this->load->view('ar/frontendtable/displaytabcat',$a);
}
...
// cartpage
  public function cart()
  {
        ...
        {
              redirect('index.php/TootController_Ar/login');
        }
  }
  ...
  public function getcartitems()
  {
     if(isset($_SESSION['cusername']) || isset($_SESSION["cgustid"]))
       ...
       $this->load->view('ar/frondendtable/cart_table',$a);
    }
    else
    {
       redirect('index.php/TootController_Ar/login');
  ...
  public function getmincartcart()
  {
     if(isset($_SESSION['cusername']) || isset($_SESSION["cgustid"]))
      ...
      $this->load->view('ar/frondendtable/mincart_table',$res);
...
//payment gateway
  public function payment_gateway()
  {
    ...
    $success_url = base_url('index.php/TootController_Ar/payment_success')."?c=".$coupon_appld."&d=".$discounded_total."&p=".$paymod."&o=".$unq_ordrid."&adrid=".$addressid."&delivery_charge=".$delivery_charge."";

    $error_url = base_url('index.php/TootController_Ar/payment_error');
...
public function payment_success()
{
   ...
   $date = date('Y-m-d h:i:sa');
    ...
    $data1 = array
      ...
      if ($result1==1)
      {
          redirect("index.php/TootController_Ar/checkoutconfirm?c=".$coupon_appld."&d=".$discounded_total."&p=".$paymod."&o=".$unq_ordrid."&adrid=".$adrsid."&delivery_charge=".$delivery_charge."");
      }
...
public function payment_error()
{
   ...
   $date = date('Y-m-d h:i:sa');
    ...
    $data1 = array
      ...
      if ($result1==1)
      {
          redirect('index.php/TootController_Ar/checkout?status=failed');
      }
...
//order_confirm  
                   ...
                   if(isset($_GET['o']))
                    {
                      ...
                      $unq_ordrid;
                      var_dump($mail);
                      redirect("index.php/TootController_Ar/checkinvoice?od=".$unq_ordrid."");
                      }
                      else
                      {
                      $unq_ordrid;
  ...
  public function checkinvoice()
  {
    ...
    // $this->load->view('ar/frontendtables/display_invoice',$getinvoicedetils);
     $a=array(
       'tabproducts'=>$this->TootModel->get_categories(),  
       'offertext'=>$this->TootModel->getoffertext(),   
       'ordergen'=>$getordergenraldtls,
      ...
      $this->load->view('ar/toottemplatear',$a);
         ...
         if($getsamemailcount==0)
         {
          ...
          if($res!=0)
          {
              ...
              (
                  ...
                  'addressprofile_company'=>$this->input->post('udelcomp'),
                  'addressprofile_address'=>$this->input->post('udeladrs'),
                  'addressprofile_state'=>$this->input->post('udelstate'),
                  'addressprofile_city'=>$this->input->post('udelcity'),
                  'addressprofile_street'=>$this->input->post('udelsrt'),
                  'addressprofile_pin'=>$this->input->post('udelpin'),
              ...
              if($res1==1)
              {
                ...
                if($changeuseridcartwish==1)
                {
                    ...
                    $content = $this->load->view('ar/register_mail_view',$data2,TRUE);
      ...
      if($getuser->num_rows()==1)
      {
           ...
           if($userpasswod==$passowrd)
           {
             ...
             $this->session->set_userdata($userlogindata);
              ...
              redirect('index.php/TootController_Ar');
    ...
    if(isset($_SESSION['cusername']))
        {
          ...
          $getadrsdtls=$this->TootModel->getadrsdetlsedit($userid);

          if(empty($getadrsdtls))
          {
             $getadrsdtls=(object) array
             (
...
// offerspage 
  ...
  //           'content' => 'offers');
    ...
    redirect('index.php/TootController_Ar/offer_products');
  }
...
//wishlist
  ...
  public function getwishlisttable()
  {
     if(isset($_SESSION['cusername']) || isset($_SESSION["cgustid"]))
      ...
      $this->load->view('ar/frondendtable/wishlisttable',$res);
    }
    else
    {
      redirect('index.php/TootController_Ar/login');
    ...
    if(isset($_SESSION['cusername']))
      {
          ...
          $this->load->view('ar/frondendtable/orders_table',$a);
          ...
          if($res==1)
          {
            ...
            (
              ...
              'name'=>'User'
                    ...
                    $content = $this->load->view('ar/ordercancel_mail',$data2,TRUE);
...
public function sortpyprice_or_name_sub()
{
  ...
  $this->load->view('ar/frondendtable/sort_products',$res);
}
...
public function sortpyprice_or_name_ofr()
{
  ...
  $res['priceprds'] = $this->TootModel->getpricenamesortprods_ofr($sortkey,$subid,$dstart,$dend);
...
public function sortpysizesheo_ofr()
{
  ...
  $res['priceprds'] = $this->TootModel->getsizenosheo_sortprods_ofr($sortkey,$subid,$dstart,$dend);
...
public function sortpysize_ofr()
{
  ...
  $res['priceprds'] = $this->TootModel->getsizeno_sortprods_ofr($sortkey,$subid,$dstart,$dend);
...
public function sortsizeltr_ofr()
{
  ...
  $res['priceprds'] = $this->TootModel->getsizeltr_sortprods_ofr($sortkey,$subid,$dstart,$dend);
